                ...
                <div className="popup-Box">
                      ...
                      <div>
                        ...
                        <div className="text-Wrap">
                            <div className="text-Title">SmartSwap transaction fee : <i className="help-circle"><i className="fas fa-question-circle protip"
                                    data-pt-position="top" data-pt-title="80% of fees goes to support liquidity for THUNDER token and 20% goes to support development"
                        ...
                        <ul className="text-Box">
                            <li><span className="icon-Box"><i className="fas fa-exclamation-circle"></i></span><span>ThunderSwap reimburses all swap fees and does not allow any loss of value due to spread or volatility. The estimated fees cost covers the swap fees and the direct cost of blockchain gas. If the user is swapping BTC, there is an additional cost for 3rd party providers to validate on-chain the exact deposit amount of BTC.</span></li>
                            <li><span> user sending BTC will deposit the maximum estimated gas cost to a temporary wallet generated by ThunderSwap and 100% owned by the user. If the total gas cost at the end of the swap is less than the estimated amount, the temporary wallet returns the balance to the user’s wallet.</span></li>
                            <li><span>ThunderSwap users have the option to receive 100% reimbursement for their gas and swap fees. Users are able to claim reimbursements via the reimbursement staking contract. To release reimbursements users must stake the 1:1 equal amount of THUNDER for one year, but will be able to release partial amounts of the reimbursement if withdrawn at any time before the 1 year period. The pending balance accumulates and the user is able to claim the rest.  </span></li>
                            <li style={{marginBottom: '0px'}}><span>Example</span></li>
                            <li><span>If over the year a user spent over $1000 or more on gas, at any time he can be reimbursed for such cost even if the THUNDER token value is higher due to appreciation.</span></li>
                        </ul>
                    </div>  
                    ...
                    {/* <div>
                        ...
                        <ul className="text-Box">
                            ...
                            <li><span>Once the final cost of gas and fees is known at the end of the swap, ThunderSwap reimburses users with THUNDER at 100%.</span></li>
                        </ul>
                    </div> */}
